            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Selamat Datang <?php echo e(Auth::user()->email); ?>!</h6>
...
<?php /**PATH /home/destroylord/htdocs/kopdig-web-simpan-pinjam/resources/views/layouts/components/navbar.blade.php ENDPATH**/ ?>