            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" target="_blank" href="landing">
                        <i class="ri-shopping-bag-3-line"></i> <span data-key="t-landing">Simpan Pinjam</span>
                    </a>
                </li>
                <!-- End Unit Usaha Menu -->
...
<?php /**PATH C:\xampp\htdocs\Akun simpan pinjam (profile + edit profile)\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>