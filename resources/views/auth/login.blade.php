                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="index.html" class="d-block">
                                                        <img src="{{ asset('assets/images/kopdig.png')}}" width="100%" height="80px" alt="" height="18">
                                                    </a>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            <div>
                                                ...
                                                <p class="text-muted">Sign in to continue KOPDIG Simpan Pinjam.</p>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <form action="{{ route('login')}}" method="POST" autocomplete="off">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"name="email" required autofocus class="form-control" id="email" placeholder="Enter email">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            <input type="password" name="password" required autofocus="current-password" class="form-control pe-5" placeholder="Enter password" id="password-input">
