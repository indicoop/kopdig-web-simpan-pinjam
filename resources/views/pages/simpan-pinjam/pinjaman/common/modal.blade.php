    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase" id="exampleModalgridLabel">Pengajuan pembayaran cicilan 1 / {{ $getLoanById->time_period}}</h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-6">
                            <div>
                                ...
                                <input type="text" class="form-control" value="{{$getLoanById->installment_principal}}" name="installment_principal" id="installment_principal" readonly>
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-6">
                            <div>
                                <label for="" class="form-label">Angsuran Bunga</label>
                                <input type="text" class="form-control" value="{{$getLoanById->interest_per_month}}" name="intereset_per_month" id="intereset_per_month">
                            </div>
                        </div><!--end col-->
                        <div class="col-xxl-12">
                            <div>
